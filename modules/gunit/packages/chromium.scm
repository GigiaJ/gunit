...
(define-public chromium-embedded-framework
  (let ((git-revision "1e6e84d")
        (chromium-version "143.0.7499.147")
    ...
    (package
      ...
      (source
       (origin
         ...
         (uri (string-append "https://cef-builds.spotifycdn.com/cef_binary_"
                             ...
                             "_minimal.tar.bz2"))
         (sha256
          (base32 "1f9rj4wv6hjgvpnz297g7nvs53nrk4k1cl1pic2ns4pir0hgsaiy"))))
      (build-system binary-build-system)
      (arguments
       `(#:patchelf-plan `(("Release/libcef.so" ("alsa-lib" "at-spi2-core"
                                                 "cairo"
                                                 "cups"
                                                 "dbus"
                                                 "expat"
                                                 ...
                                                 ("nss" "/lib/nss")
                                                 "pango")))
         #:install-plan `(("Release/libcef.so" "lib/")
      ...
      (description
       "This library provides a simple framework for embedding
