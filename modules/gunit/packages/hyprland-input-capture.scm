...
(define-module (gunit packages hyprland-input-capture)
  #:use-module ((guix licenses) #:prefix license:)
  #:use-module (guix packages)
  #:use-module (gunit packages libinput-input-capture)
  ...
  #:use-module (gunit packages hyprland-protocols-input-capture)
